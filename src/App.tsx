import { Canvas, Vec2dModel, TldrawEditor, useEditor } from "@tldraw/tldraw";
...
export default function CustomUiExample() {
  return (
    <div className="tldraw__editor" style={{ aspectRatio: 4 / 3 }}>
...
const CustomUi = track(() => {
  ...
  useEffect(() => {
    const resizeHandler = (ev: Event) => {
      editor.shapesArray.forEach((shape) => {
        const window = ev.target as Window;
        editor.resizeShape(
          shape.id,
          {
            x: window.innerWidth / windowWidth,
            y: window.innerWidth / windowWidth,
            z: 0,
          },

          { mode: "scale_shape", scaleOrigin: { x: 0, y: 0, z: 0 } }
        );
      });
    };
  ...
  }, [editor.shapesArray, editor, windowHeight, windowWidth]);
  ...
  //   editor.createShapes([
  //     {
  //       id: `shape:${crypto.randomUUID}` as TLShapeId,
  //       type: "draw",
  //       x: 0,
  //       y: 0,
  //       props: {
